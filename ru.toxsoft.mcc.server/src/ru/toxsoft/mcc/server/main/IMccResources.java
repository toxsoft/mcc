...
interface IMccResources {
  ...
  String STR_N_IRREVERSIBLE_ENGINE_PWR                = "Нет питания";

  String STR_N_MAIN_SWITCH_EMERGENCY_STOP     = "Кнопка STOP";
  ...
  String STR_N_MAIN_SWITCH_POWER_CONTROL      = "Hет напряжения управления";
  ...
  String STR_N_REVERSIBLE_ENGINE_POWER_CONTROL     = "Нет напряжения управления";
  String STR_N_REVERSIBLE_ENGINE_PWR               = "Нет питания";
