...
public class MccPurgeBaloon
  ...
  private static final Gwid dataGwid = Gwid.createRtdata( "mcc.CtrlSystem", "n2CtrlSystem", "rtdBlowCmplt" ); //$NON-NLS-1$ //$NON-NLS-2$//$NON-NLS-3$
  ...
  public MccPurgeBaloon( MccSchemePanel aOwner, ITsGuiContext aTsContext, IdChain aConnId ) {
    super( aOwner, dataGwid, aTsContext, aConnId );
    mrLabel = new MccMultiRowLabel( aTsContext );
    mrLabel.setText( new StringArrayList( "Продувка" ) );
    ...
    baloon = new MccBaloon( 280, 140, 80, 28, 12, 12, 12, 6, ETsFulcrum.BOTTOM_CENTER, aTsContext );
    mrLabel.setTextPlacementArea( new Rectangle( 280, 140, 80, 32 ) );
