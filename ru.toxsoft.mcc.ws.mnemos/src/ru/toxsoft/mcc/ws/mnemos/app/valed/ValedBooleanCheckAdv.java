 ...
 * @author vs
 */
public class ValedBooleanCheckAdv
    extends AbstractValedControl<Boolean, CLabel> {
  ...
  static class Factory
    ...
    protected IValedControl<Boolean> doCreateEditor( ITsGuiContext aContext ) {
      AbstractValedControl<Boolean, ?> e = new ValedBooleanCheckAdv( aContext );
   ...
   */
  public ValedBooleanCheckAdv( ITsGuiContext aTsContext ) {
    super( aTsContext );
  }
  ...
  protected CLabel doCreateControl( Composite aParent ) {
    ...
    try {
      ...
      bkPanel = new CLabel( aParent, SWT.NONE );
  ...
  protected void doSetUnvalidatedValue( Boolean aValue ) {
    ...
    if( value ) {
      bkPanel.setImage( imgCheckTrue );
      bkPanel.setText( trueText );
    }
    else {
      bkPanel.setImage( imgCheckFalse );
      bkPanel.setText( falseText );
    }
    bkPanel.redraw();
  }
