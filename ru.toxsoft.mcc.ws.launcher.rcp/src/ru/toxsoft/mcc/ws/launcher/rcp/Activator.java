...
import ru.toxsoft.mws.module.s5.journals.ICfgConstants;
import ru.toxsoft.mws.module.s5.journals.models.OdsFileObjModel;
...
public class Activator
  ...
  protected void doStart() {
    ...
    // установка модели дерева объектов
    ICfgConstants.EVENTS_FILTER_OBJECTS_TREE_MODEL.setValue( mws.mwsContext().params(),
        DvUtils.avStr( OdsFileObjModel.class.getName() ) );
